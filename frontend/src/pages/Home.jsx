  ...
  return (
    <div className="h-full w-full  relative bg-[#111111af] px-4  md:px-15">
      ...
      <div className="hero  flex items-center min-h-screen  justify-center flex-col gap-7">
        ...
        <Link
          to={"/chat"}
          className="py-1.5 px-3 text-sm md:text-base bg-white group text-black rounded-full cursor-pointer transition-all duration-200 hover:scale-105 flex items-center justify-center gap-2"
        >
          Try OrinAI
